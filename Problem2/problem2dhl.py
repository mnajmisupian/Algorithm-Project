...
def dhl(first, second, third):
    ...
    plt.bar(xKey, yVal)
    plt.savefig("Problem2\DHL\wordCount.svgz")
    plt.savefig("Problem2\DHL\wordCount.png")
    # plt.show()
    ...
    plt.bar(xPW, yPWV)
    plt.savefig("Problem2\DHL\posWord.svgz")
    plt.savefig("Problem2\DHL\posWord.png")
    # plt.show()
    ...
    plt.bar(xPN, yPNval)
    plt.savefig("Problem2\DHL\posNeg.png")
    # plt.show()
