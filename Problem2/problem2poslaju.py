...
def poslaju(first, second, third):
    ...
    plt.bar(xKey,yVal)
    plt.savefig("Problem2\PosLaju\wordCount.svgz")
    plt.savefig("Problem2\PosLaju\wordCount.png")
    # plt.show()
    plt.clf()
    ...
    plt.bar(xPW,yPWV)
    plt.savefig("Problem2\PosLaju\posWord.svgz")
    plt.savefig("Problem2\PosLaju\posWord.png")
    # plt.show()
    plt.clf()
    ...
    plt.bar(xPN,yPNval)
    plt.savefig("Problem2\PosLaju\posNeg.png")
    # plt.show()
    plt.clf()
