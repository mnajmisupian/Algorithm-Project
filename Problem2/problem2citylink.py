...
def citylink(first, second, third):
    ...
    plt.bar(xKey,yVal)
    plt.savefig("Problem2\CityLink\wordCount.svgz")
    plt.savefig("Problem2\CityLink\wordCount.png")
    # plt.show()
    plt.clf()
    ...
    plt.bar(xPW,yPWV)
    plt.savefig("Problem2\CityLink\posWord.svgz")
    plt.savefig("Problem2\CityLink\posWord.png")
    # plt.show()
    plt.clf()
    ...
    plt.bar(xPN,yPNval)
    plt.savefig("Problem2\CityLink\posNeg.png")
    # plt.show()
    plt.clf()
