...
def jnt(first, second, third):
    ...
    barChart(wordKeyList, wordValueList, "Word Frequency", "Frequency", "Word", 8, "Problem2\J&T\wordCount", 150, 150)
    ...
    barChart(negativeWord, negativeWordVal, "Negative Word Frequency", "Frequency", "Negative Word", 20, "Problem2\J&T\\negWord", 20, 20)
...
def cityLink(first, second, third):
    ...
    pageHtml1 = pageOpen1.read().decode("utf-8")
    htmlParsed1 = BeautifulSoup(pageHtml1,"html.parser")
    mainParsed1 = htmlParsed1.find("div", attrs={"id" : "story-body" , "class" : "story bot-15 relative"})
    mainP1 = mainParsed1.find_all("p")
    ...
    pageHtml2 = pageOpen2.read().decode("utf-8")
    htmlParsed2 = BeautifulSoup(pageHtml2,"html.parser")
    mainParsed2 = htmlParsed2.find("div", attrs={"class" : "paragraph" , "mlnid" : "idcon=270416;order=3.0"})
    mainP2 = mainParsed2.find_all("p")
    ...
    barChart(wordKeyList, wordValueList, "Word Frequency", "Frequency", "Word", 8, "Problem2\CityLink\wordCount", 100, 100)
    ...
    barChart(positiveWord, positiveWordVal, "Positive Word Frequency", "Frequency", "Positive Word", 10, "Problem2\CityLink\posWord", 20, 20)
    barChart(negativeWord, negativeWordVal, "Negative Word Frequency", "Frequency", "Negative Word", 20, "Problem2\CityLink\\negWord", 20, 20)
...
def posLaju(first, second, third):
    ...
    pageHtml0 = pageOpen0.read().decode("utf-8")
    htmlParsed0 = BeautifulSoup(pageHtml0,"html.parser")
    mainParsed0 = htmlParsed0.find("div", attrs={"id" : "story-body" , "class" : "story bot-15 relative"})
    mainP0 = mainParsed0.find_all("p")
    ...
    barChart(wordKeyList, wordValueList, "Word Frequency", "Frequency", "Word", 8, "Problem2\PosLaju\wordCount", 100, 100)
    ...
    barChart(positiveWord, positiveWordVal, "Positive Word Frequency", "Frequency", "Positive Word", 10, "Problem2\PosLaju\posWord", 20, 20)
